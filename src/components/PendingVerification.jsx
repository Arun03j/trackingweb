...
const PendingVerification = ({ user, userProfile }) => {
  ...
  const getRoleDescription = (role) => {
    switch (role) {
      case 'driver':
        return 'Your driver account is being reviewed. Once approved, you will be able to share your live location for bus tracking.';
      case 'student':
        return 'Your student account is being reviewed. Once approved, you will be able to view bus locations and track live drivers.';
      default:
        return 'Your account is being reviewed by an administrator.';
    }
  };
